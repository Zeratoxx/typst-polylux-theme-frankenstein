...
#let frankenstein-dark = rgb("#192e41")
#let frankenstein-bright = rgb("#fafafa")
#let frankenstein-accent = rgb("#fc9278")
#let frankenstein-colors = state("frankenstein-colors", (:))
#let frankenstein-short-date = state("frankenstein-short-date", none)
#let frankenstein-progress-bar = state("frankenstein-progress-bar", true)
...
#let frankenstein-theme(
  ...
  set text(font: "Calibri", weight: "light")
  show math.equation: set text(font: "Fira Math")

  frankenstein-progress-bar.update(progress-bar)
  frankenstein-colors.update((a: color-a, b: color-b, c: color-c))
  frankenstein-short-date.update(short-date)
...
#let title-slide(title: [], subtitle: none, author: [], date: none) = {
  ...
  let content = {
    ...
    title-block(frankenstein-bright, frankenstein-dark, 40%, {
      if subtitle != none {
...
#let west-slide(title: none, body) = {
  let content = {
    _frankenstein-content-box(
      frankenstein-bright, frankenstein-dark, 30%, left,
...
#let east-slide(title: none, body) = {
  let content = {
    ...
    _frankenstein-content-box(
      frankenstein-bright, frankenstein-dark, 30%, right,
      if title != none { heading(level: 2, title) } else { [] }
    )
  }
  logic.polylux-slide(content)
